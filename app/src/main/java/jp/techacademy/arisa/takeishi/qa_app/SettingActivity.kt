...
//Preferenceから表示名を取得してEditTextに反映させることと、
// 表示名変更ボタンとログアウトボタンのOnClickListenerを設定することを実装
class SettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //表示名変更ボタン
        changeButton.setOnClickListener { v -> //★vとは？
            // キーボードが出ていたら閉じる
        ...
        //ログアウトボタンでログアウト処理
        //ログアウトはFirebaseAuthクラスのsignOutメソッドを呼び出し、
        //Preferenceに空文字（”“)を保存し、
